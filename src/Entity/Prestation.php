...
use App\Controller\AjouterPrestationAction;
use App\Controller\Delete\DeletePrestationAction;
...
#[ApiResource(
    normalizationContext: ['groups' => ['read:Prestation','read:Entity']],
    denormalizationContext: ['groups' => ['write:Prestation','write:Entity']],
    operations: [
        new Get(),
        new GetCollection(),
        new Post(
            controller: AjouterPrestationAction::class,
            write: false,
...
//        ),
        new Delete(
            security: "is_granted('ROLE_ADMIN')",
            controller: DeletePrestationAction::class,
            write: false
        ),
    ]
)]
...
class Prestation implements UserOwnedInterface
{
