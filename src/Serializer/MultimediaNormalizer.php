...
final class MultimediaNormalizer implements ContextAwareNormalizerInterface, NormalizerAwareInterface
{
    use NormalizerAwareTrait;

    private const ALREADY_CALLED = 'MULTIMEDIA_NORMALIZER_ALREADY_CALLED';
    ...
    public function supportsNormalization($data, ?string $format = null, array $context = []): bool
    {
        ...
        return $data instanceof Multimedia && (count($data->getFichiers()) === 0);
    }
