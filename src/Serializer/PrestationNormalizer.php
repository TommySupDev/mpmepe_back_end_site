...
final class PrestationNormalizer implements ContextAwareNormalizerInterface, NormalizerAwareInterface
{
    use NormalizerAwareTrait;

    private const ALREADY_CALLED = 'PRESTATION_NORMALIZER_ALREADY_CALLED';
    ...
    public function supportsNormalization($data, ?string $format = null, array $context = []): bool
    {
        ...
        return $data instanceof Prestation && (count($data->getFichiers()) === 0);
    }
